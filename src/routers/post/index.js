...
router.post(
	...
	asyncHanlder(PostController.publishPostWithThumbnail)
);
...
router.delete(
	'/unSavePost/:saveListId/:postId',
	asyncHanlder(PostController.unSavePost)
);
router.get('/saveLists', asyncHanlder(PostController.getSaveListName));
router.delete(
	'/saveList/:saveListId',
	asyncHanlder(PostController.deleteSaveList)
);
